 ...
 */
       ...
       ArrayList<String> listUlkeler = new ArrayList<>(List.of("Almanya", "Fransa", "Ingiltere", "Ispanya", "Italya"));
        ...
        System.out.println("2. index dahil, 5. index haric parcası alındu : " + listParcasi.subList(2, 5));//2. 3. 4. elemanı alır. 5 . eleman alınmaz
        ...
        //****ÇOOOK ÖNEMLİ Süleyman hoca bile yanlış anlattı....Collections.reverse()--> methodu listteki elemanları index sırasına göre tersten sıralar.
